...
mkdir /data
wget -O /data/tls.pem "https://raw.githubusercontent.com/santzx45/zxvpn/main/vmess/certi.pem"
wget -O /data/tls.key "https://raw.githubusercontent.com/santzx45/zxvpn/main/vmess/certi.key"
