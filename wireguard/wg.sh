...
echo -e "${Info} Wireguard Script Mod By ZX"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/santzx45/zxvpn/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/santzx45/zxvpn/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/santzx45/zxvpn/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
