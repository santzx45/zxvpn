...
cd /usr/bin
wget -O addss-p "https://raw.githubusercontent.com/santzx45/zxvpn/main/shadowsocks-plugin/addss-p.sh"
chmod +x addss-p
#wget -O shadowhost "https://raw.githubusercontent.com/santzx45/zxvpn/main/shadowsocks-plugin/shadowhost.sh"
#chmod +x shadowhost && shadowhost
wget -O delss "https://raw.githubusercontent.com/santzx45/zxvpn/main/shadowsocks/delss.sh"
cd
...
rm -rf gost-plugin
cd /usr/bin/
wget -O gost-plugin "https://raw.githubusercontent.com/santzx45/Shadowsocks-Plugin/main/gost-plugin"
wget -O v2ray-plugin "https://raw.githubusercontent.com/santzx45/Shadowsocks-Plugin/main/v2ray-plugin"
wget -O xray-plugin "https://raw.githubusercontent.com/santzx45/Shadowsocks-Plugin/main/xray-plugin"
chmod +x gost-plugin
