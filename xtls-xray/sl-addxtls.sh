...
slvlesswslink="vless://${uuid}@${domain}:7869/?path=/zxofficial&security=xtls&encryption=none&sni=${domain}&flow=${muncrat}&type=ws#${user}"
slvmesswslink="vmess://${uuid}@${domain}:7869/?path=/zxofficial&security=xtls&encryption=none&sni=${domain}&flow=${muncrat}&type=ws#${user}"
...
echo -e "Script Create Auto Account by ZX "
echo -e "================================="
echo -e "Remarks              : ${user}"
